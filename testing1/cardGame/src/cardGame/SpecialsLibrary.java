         ...
         // Check if the network forced an outcome!
            ...
            switch (cardId) {
                ...
                case "01019": // Lucky Gun Slinger
                    ...
                    headsMsg = "HEADS! Freeze Ball! The target is frozen solid for 3 rounds!";
                    tailsMsg = "TAILS! The freeze ball missed.";
        ...
        switch (action.toLowerCase()) {
            ...
            case "silence": {
                ...
                for (BattleCard t : silenceTargets) {
                    if (t != null) {
                        ...
                        System.out.println("LIBRARY: " + t.getBaseCard().getName() + " was silenced and cannot use specials!");
                    }
                }
                return true;
            }
         ...
         // === TIER 2: Water Bubble Shield (01022) ===
            ...
            case "frozen": {
                ...
                java.util.List<BattleCard> freezeTargets = (targets != null && !targets.isEmpty()) ? targets : java.util.Collections.singletonList(caster);
                
                for (BattleCard t : freezeTargets) {
                    if (t != null) {
                        api.addStatus(t, "FROZEN", param);
                        System.out.println("LIBRARY: " + t.getBaseCard().getName() + " was frozen for " + param + " turns!");
                    }
                }
                return true;
            }
